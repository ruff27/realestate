...
function generateProperties(count) {
  return Array(count).fill().map((_, index) => ({
    id: index + 1,
    title: `${['Cozy', 'Spacious', 'Modern', 'Elegant', 'Charming', 'Stylish', 'Luxurious'][index % 7]} ${['Apartment', 'House', 'Condo', 'Studio', 'Loft', 'Duplex', 'Penthouse'][index % 7]} in ${dhakaLocations[index % dhakaLocations.length]}`,
    price: Math.floor(Math.random() * (100000 - 10000) + 10000),
    type: ['apartment', 'house', 'condo', 'studio', 'loft', 'duplex', 'penthouse'][index % 7],
...
const rentProperties = generateProperties(100);
                ...
                <Card sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
                  ...
                  <CardContent sx={{ flexGrow: 1 }}>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      {property.price.toLocaleString()} BDT/month
                    </Typography>
                    <Typography variant="body2" color="text.secondary">
